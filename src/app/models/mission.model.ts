...
export const DAILY_POOL: MissionDef[] = [
  ...
  },
  {
    id: 'd-merge30',
    icon: '🔀',
    desc: '30 birleşme yap',
    descEn: 'Make 30 merges',
    metric: 'merges',
    target: 30,
    gold: 30,
  },
  ...
  },
  {
    id: 'd-level1',
    icon: '🎯',
    desc: '1 seviye tamamla',
    descEn: 'Complete 1 level',
    metric: 'levels',
    target: 1,
    gold: 35,
  },
...
export const WEEKLY_POOL: MissionDef[] = [
  ...
  },
  {
    id: 'w-merge300',
    icon: '🔀',
    desc: '300 birleşme yap',
    descEn: 'Make 300 merges',
    metric: 'merges',
    target: 300,
    gold: 120,
  },
  {
    id: 'w-level5',
    icon: '🎯',
    desc: '5 seviye tamamla',
    descEn: 'Complete 5 levels',
    metric: 'levels',
    target: 5,
    gold: 140,
  },
  ...
  },
  {
    id: 'w-1024',
    icon: '🟪',
    desc: '1024 karesi yap',
    descEn: 'Make a 1024 tile',
    metric: 'reach1024',
    target: 1,
    gold: 180,
  },
  {
    id: 'w-gold500',
    icon: '💰',
    desc: '500 altın kazan',
    descEn: 'Earn 500 gold',
    metric: 'gold',
    target: 500,
    gold: 100,
  },

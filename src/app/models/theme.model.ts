...
/** Tema kataloğu. Adlar i18n'de: theme.<id>.name (src/app/i18n/<lang>.json). */
export const THEMES: ThemeDef[] = [
  { id: 'light', price: 0, swatch: ['#faf8ef', '#bbada0', '#edc22e'] },
  { id: 'dark', price: 0, swatch: ['#1a1917', '#3b3733', '#edc22e'] },
  { id: 'neon', price: 200, swatch: ['#0d0221', '#7b2ff7', '#00e5ff'] },
  { id: 'ocean', price: 300, swatch: ['#0a2540', '#1e88c7', '#48cae4'] },
  { id: 'forest', price: 250, swatch: ['#e9f5e1', '#4e8a45', '#8bc34a'] },
  { id: 'sunset', price: 200, swatch: ['#2a1a2e', '#e8623a', '#f9c74f'] },
];
